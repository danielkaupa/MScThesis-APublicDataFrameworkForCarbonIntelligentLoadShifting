...
meter_save_directory = os.path.join(data_save_directory, "meter_primary_files")
...
# file paths
meter_readings_2021_path = os.path.join(meter_save_directory, f"{meter_readings_2021_filename}.parquet")
meter_readings_2022_path = os.path.join(meter_save_directory, f"{meter_readings_2022_filename}.parquet")
meter_readings_2023_path = os.path.join(meter_save_directory, f"{meter_readings_2023_filename}.parquet")
...
temp = re.search(r"_(\d{8}_\d+)$", meter_readings_filename)
if not temp:
