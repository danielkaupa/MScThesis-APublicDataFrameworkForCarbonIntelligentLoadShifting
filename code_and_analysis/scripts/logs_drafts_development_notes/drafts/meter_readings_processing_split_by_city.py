# ────────────────────────────────────────────────────────────────────────────
# FILE: meter_readings_processing_split_by_city.py
...
# OUTPUTS: Parquet files containing meter reading data for each city, saved
# in the specified directory. The files should be named in the format
# 'meter_readings_CITY_YEAR_TIMESTAMP_formatted.parquet'. In this case,
# we expect data for the cities of Delhi and Mumbai to be processed.
# ────────────────────────────────────────────────────────────────────────────
...
def filter_and_save_unique_city_file(file_path: str,
                                     city: str,
                                     output_dir: str) -> None:
    """
