...
for year in [2021, 2022, 2023]:
    ...
    # Run the psql command and read the output into a Polars DataFrame
    proc = subprocess.Popen(psql_cmd, stdout=subprocess.PIPE, stderr=subprocess.PIPE, text=True)
    df = pl.read_csv(proc.stdout, infer_schema_length=50_000)
